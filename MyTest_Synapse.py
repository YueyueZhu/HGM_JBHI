...
parser.add_argument('--pth_path', type=str, default='./HGM_Synapse_best_parameter.pth')
parser.add_argument('--test_path', type=str,default='./Synapse/test_vol_h5_new', help='path to train dataset')
parser.add_argument('--results_save_place', type=str, default='./results/'+ test_dataset_name +'_01')
parser.add_argument('--list_dir', type=str, default='./Synapse', help='list_dir')
