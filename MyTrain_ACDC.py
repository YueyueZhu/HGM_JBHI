...
def train(train_loader, model, optimizer, epoch, device, opt):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            images, gts = images.type(torch.FloatTensor), gts.type(torch.FloatTensor)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='./ACDC', help='path to train dataset')
    parser.add_argument('--test_path', type=str,
                        default='./ACDC/test', help='path to train dataset')
    parser.add_argument('--list_dir', type=str,
                        default='./ACDC/lists_ACDC', help='list_dir')
    # Preparameter 
    parser.add_argument('--pre_parameter', type=str, default="./HGM_ACDC_best_parameter.pth", help='Load model from a .pth file')
    # Save Checkpoint
    ...
    db_train = ACDCdataset(base_dir=opt.train_path, list_dir=opt.list_dir, split="train",
