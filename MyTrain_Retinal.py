...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str,
                        default='./Retinal/train/', help='path to train dataset')
    parser.add_argument('--test_path', type=str,
                        default='./Retinal/test/' + test_dataset_name, help='path to train dataset')
    # Preparameter 
    parser.add_argument('--pre_parameter', type=str, default="./HGM_Retinal_best_parameter.pth", help='Load model from a .pth file')
    # Save Checkpoint
    parser.add_argument('--train_save', type=str,default='./parameter/test.pth')
